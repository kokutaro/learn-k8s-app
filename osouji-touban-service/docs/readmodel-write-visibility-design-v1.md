...
#### RMV-01: Projection visibility option 追加
...
#### RMV-02: Event write metadata に `GlobalPosition` を追加
...
#### RMV-03: ReadModel consistency context accessor 追加
...
#### RMV-04: transaction commit 後 token 発行
...
#### RMV-05: visibility checkpoint 用 migration 追加
...
#### RMV-06: visibility checkpoint repository 実装
...
#### RMV-07: ReadModel cache invalidation task repository / worker 実装
...
#### RMV-08: projector に visibility advance を組み込む
...
#### RMV-09: waiter abstraction と Postgres 実装追加
...
#### RMV-10: mutation endpoint 共通 helper 追加
...
#### RMV-11: create / update 系 endpoint へ適用
