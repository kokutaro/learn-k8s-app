...
public sealed class UnassignUserFromAreaUseCase : IRequestHandler<UnassignUserFromAreaRequest, ApplicationResult<DomainUnit>>
{
    private readonly ICleaningAreaRepository _cleaningAreaRepository;
    private readonly IApplicationTransaction _transaction;
    private readonly IDomainEventDispatcher _domainEventDispatcher;

    public UnassignUserFromAreaUseCase(
